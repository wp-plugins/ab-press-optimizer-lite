(function() {
	...
	tinymce.create('tinymce.plugins.abPressPlugin', {
		init : function(ed, url) {
			...
			url = url.replace('/js', '');
			// Register commands
			ed.addCommand('ab_press_button', function() {
				ed.windowManager.open({
					...
					height : 200 + parseInt(ed.getLang('button.delta_height', 0)), // size of our window
					inline : true,
				}, {
					plugin_url : url
				});
			...
			// Register buttons
			ed.addButton('ab_press_button', {title : 'Insert An AB Press Optimizer Experiment', cmd : 'ab_press_button', image: url + '/assets/abPress-tinymc-icon.png' });
		},
